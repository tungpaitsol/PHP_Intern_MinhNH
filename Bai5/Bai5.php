...
if (isset($_POST['ok'])) {
    ...
    $id = 0;
    for ($i = 0; $i < $input; $i++) {
        $info[$i] = array('ID' => $id++, 'Name' => $product[rand(0, 9)], 'Price' => rand(1, 10000), 'Quantity' => rand(0, 100), 'Order' => rand(0, 100));
...
function output($arr)
{
    ...
    <table border="1px" align="center">
        ...
        echo "<td colspan='6'>";
        echo "<input style='width:100%' type='submit' name='save' value='Save'>";
        echo "</td>";
        echo "<form>";
        ?>
    </table>
